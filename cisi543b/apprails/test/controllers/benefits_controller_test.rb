...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { active_status: @benefit.active_status, comment: @benefit.comment, name: @benefit.name, sort_order: @benefit.sort_order } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { active_status: @benefit.active_status, comment: @benefit.comment, name: @benefit.name, sort_order: @benefit.sort_order } }
